...
CREATE UNIQUE INDEX from_web_pkey ON public.from_web USING btree (id);

alter table "public"."from_web" add constraint "from_web_pkey" PRIMARY KEY using index "from_web_pkey";
